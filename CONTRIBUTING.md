...
Thank you for your interest in contributing to PingPong! This document provides guidelines and instructions for contributing to the project.
...
**Do not** open public issues for security vulnerabilities. Follow the [Security Policy](SECURITY.md) and report vulnerabilities privately to `security@pingpong.one`.
...
Thank you for contributing to PingPong! 🎉
